...
@logger.catch()
def get_klines_futures_without_api(symbol: str, timeframe: str, interval: int):
    time_frame_tuple = ('1m', '3m', '5m', '15m', '30m', '1h', '2h', '4h', '6h', '8h', '12h', '1d', '3d', '1w', '1M')
    if timeframe in time_frame_tuple:
        url = f'https://fapi.binance.com/fapi/v1/klines?symbol={symbol}&interval={timeframe}&limit={interval + 2}'
